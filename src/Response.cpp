...
Response::Response() : m_client_request(nullptr)
{
	log("default response created");
}
...
Response& Response::operator=(const Response& other) {
  if (this != &other)
  {
	...
	m_client_request = other.m_client_request;
    m_headers = other.m_headers;
    m_DB_status = other.m_DB_status;
    m_DB_ContentType = other.m_DB_ContentType;
    m_total_response = other.m_total_response;
